...
var _STAR_html_mode_STAR_18039 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_18039;
}});
/**
...
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__18040){
var vec__18042 = p__18040;
var name = cljs.core.nth.call(null,vec__18042,(0),null);
var value = cljs.core.nth.call(null,vec__18042,(1),null);
if(value === true){
if(cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_.call(null))){
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__18043){
var vec__18046 = p__18043;
var tag = cljs.core.nth.call(null,vec__18046,(0),null);
var content = cljs.core.nthnext.call(null,vec__18046,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else {
}

var vec__18047 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__18047,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__18047,(1),null);
var id = cljs.core.nth.call(null,vec__18047,(2),null);
var class$ = cljs.core.nth.call(null,vec__18047,(3),null);
...
var vec__18049 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__18049,(0),null);
var attrs = cljs.core.nth.call(null,vec__18049,(1),null);
var content = cljs.core.nth.call(null,vec__18049,(2),null);
if(cljs.core.truth_((function (){var or__16826__auto__ = content;
